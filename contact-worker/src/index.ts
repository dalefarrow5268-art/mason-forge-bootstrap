...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    main { width:min(1500px, 100%); border:1px solid var(--line); background:rgba(5,10,16,.92); border-radius:8px; box-shadow:0 18px 60px rgba(0,0,0,.45); padding:22px; display:grid; grid-template-columns:minmax(470px,1fr) minmax(420px,.9fr); gap:18px; align-items:start; }
    .uploadPane { min-width:0; }
    @media (max-width:960px) { main { display:block; } .card { margin-top:18px !important; } }
    ...
    .card { display:none; margin-top:0; padding:18px; border:1px solid #18bdf4; border-radius:8px; background:#08131d; }
