...
PREPARATION_VERSION='detail-tiles-v1'
...
def main():
    ...
    if not any(x.get('name')=='RELEASE_ID' and x.get('text')=='2026-09-05-holding-detail-tiles' for x in bindings):raise RuntimeError('Holding scanner deployment not live')
