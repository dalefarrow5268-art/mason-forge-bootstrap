...
export async function ensureRuntimeSchema(env) {
 ...
 error TEXT, updated_at TEXT NOT NULL, finished_at TEXT
    ...
    env.DB.prepare(`CREATE TABLE IF NOT EXISTS takeoff_crew_runs (
 ...
 error TEXT, started_at TEXT NOT NULL, updated_at TEXT NOT NULL, finished_at TEXT
    ...
    env.DB.prepare(`CREATE TABLE IF NOT EXISTS takeoff_worker_jobs (
 ...
 UNIQUE(task_id, worker_kind)
    ...
    env.DB.prepare(`CREATE INDEX IF NOT EXISTS takeoff_worker_pending ON takeoff_worker_jobs(status, updated_at)`),
    env.DB.prepare(`CREATE INDEX IF NOT EXISTS takeoff_worker_task ON takeoff_worker_jobs(task_id, worker_kind)`),
