...
<body>
  <main>
    ...
    headers: {
      ...
      "cache-control": "no-store",
      "content-security-policy": "default-src 'none'; style-src 'unsafe-inline'; form-action 'self' https://chatgpt.com https://*.chatgpt.com https://openai.com https://*.openai.com; base-uri 'none'; frame-ancestors 'none'",
